...
class WeatherAdapter(private val weatherListViewModel: WeatherListViewModel, private val weather: List<LocationWeather>) : RecyclerView.Adapter<WeatherViewHolder>() {

    private val onItemClickListener: RecyclerItemListener = object : RecyclerItemListener {
        override fun onItemSelected(weather: LocationWeather) {
